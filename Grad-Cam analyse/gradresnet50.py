...
# 載入 ResNet50 預訓練模型並修改輸出層
model = models.resnet50(weights=ResNet50_Weights.DEFAULT)
model.fc = torch.nn.Linear(model.fc.in_features, 7)  # FER+ 有 7 類
model.load_state_dict(torch.load("resnet50_emotion_CK+.pth", map_location=device))
model.to(device)
model.eval()
